...
python t34_score.py              # → score.csv, summary.md, claims_to_judge*.csv
```
...
- `claims_judged_2026-09-19.csv` — the 33 A–C paraphrases with the human verdicts; `claims_to_judge_cond0.csv` — the 9 condition-0 rows awaiting a verdict.
